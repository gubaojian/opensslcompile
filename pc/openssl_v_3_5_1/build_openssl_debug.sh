...
rm -rf cdeps_debug_openssl_3_5_1.zip
...
rm -rf $HOME/cdeps_debug/openssl
 ...
 ./Configure --prefix=$HOME/cdeps_debug/openssl --openssldir=$HOME/cdeps_debug/openssl --debug
 make -j12
 make install_sw
cd ..
rm -rf cdeps_debug_openssl_3_5_1.zip
cd $HOME/cdeps_debug/
zip -r cdeps_debug_openssl_3_5_1.zip openssl
echo "openssl build and packaging completed."
mv cdeps_debug_openssl_3_5_1.zip "$SCRIPT_DIR/cdeps_debug_openssl_3_5_1.zip"
echo "Package moved to script directory: $SCRIPT_DIR/cdeps_debug_openssl_3_5_1.zip"
echo "Build script completed successfully."
cd $SCRIPT_DIR
rm -rf $HOME/cdeps_source/openssl-3.5.1
mv openssl-3.5.1 $HOME/cdeps_source/
